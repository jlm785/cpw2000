c================    L-BFGS-B (version 2.3)   ==========================
     ...
     +                 nbd(n), iwa(3*n), isave(44)
      real*8           f, factr, pgtol, x(n), l(n), u(n), g(n),
...
c
c       Minpack2 Library ... timer, dmeps.
c
...
c                             the truncated Newton step has been used.
 ...
 2001 format
     +  (/,'At iterate',i5,4x,'f= ',1p,d12.5,4x,'|proj g|= ',1p,d12.5)
 3001 format(2(1x,i4),2(1x,i5),2x,a3,1x,i4,1p,2(1x,d8.1),1p,2(1x,d10.3))
...
c     ************
 ...
 1004 format (/,a4, 1p, 6(1x,d11.4),/,(4x,1p,6(1x,d11.4)))
 3002 format(2(1x,i4),2(1x,i5),2x,a3,1x,i4,1p,2(1x,d8.1),6x,'-',10x,'-')
 3003 format (/,
     + '           * * *',/,/,
