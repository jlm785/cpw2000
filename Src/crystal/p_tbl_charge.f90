...
!>   Gives the nuclear charge of an element.
!>   All elements from H to Og + "ZZ" are included.
!>
!>  \author       Norman Troullier, Jose Luis Martins
!>  \version      5.10
!>  \date         May 1, 1991, 29 December 2023.
