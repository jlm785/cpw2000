...
!>     Calculates the indexes, kinetic energies, length of k
...
!      sort ekin
         ...
         xsum = (rkpt(1)*bdot(1,1) + rkpt(2)*bdot(2,1) +                 &
     &          rkpt(3)*bdot(3,1))*rkpt(1) +                             &
     &         (rkpt(1)*bdot(1,2) + rkpt(2)*bdot(2,2) +                  &
     &          rkpt(3)*bdot(3,2))*rkpt(2) +                             &
     &         (rkpt(1)*bdot(1,3) + rkpt(2)*bdot(2,3) +                  &
     &          rkpt(3)*bdot(3,3))*rkpt(3)
