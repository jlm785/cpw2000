       subroutine hk_psi_c8(mtxd,neig,psi,hpsi,lnewanl,                 &
     & ng,kgv,                                                           &
...
!      copyright INESC-MN/Jose Luis Martins
       ...
       implicit none
       integer, parameter          :: REAL64 = selected_real_kind(6)
...
!      output
       ...
       call compact_expand_c8(psi,mtxd,neig,mxddim,'C')
       call compact_expand_c8(anlga,mtxd,nanl,mxddim,'C')


        call hk_psi_c8_cuda(mtxd,neig,psi,hpsi, lnewanl,             &
     & ng,kgv,                                                           &
     & qmod,isort,vscr,kmscr,                                            &
     & anlga,xnlkb,nanl,                                                 &
     & mtxd,mxdbnd,mxdanl,mxdgve,mxdscr)

       call compact_expand_c8(psi,mtxd,neig,mxddim,'E')
       call compact_expand_c8(hpsi,mtxd,neig,mxddim,'E')
       call compact_expand_c8(anlga,mtxd,nanl,mxddim,'E')

      

       return

       end subroutine hk_psi_c8
