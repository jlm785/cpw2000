...
!>     it is an interface to force_stress_kb with some extra functions
...
!      version 4.95
       ...
       type(enfrst_t)                     ::  total_                     !<  Total energy force stress       type(flags_t)                      ::  flags_                     !<  computational flags
...
!      Adds keating correction
       ...
       if(flags_%flgkeat == 'KEATNG') then
         ...
         write(6,*) 'Using Keating ForceField Corrections'
