...
!>
!>     All the input is recorded in a file so calculations can be reproduced
!>     or a similar calculation
...
!      loop over tasks
       ...
       do i=1,100
         ...
         write(6,*)
         write(6,*) '  1) Generate band structures, density-of-states'
         write(6,*) '     oscillator strengths, k.p files,'
         write(6,*) '     optical response, etc...'
         write(6,*)
