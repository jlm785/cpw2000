...
!>  \version      5.13
!>  \date         April 22, 1999, 10 March 2026.
!>  \copyright    GNU Public License v2

  subroutine gvec_star_from_cube(den, nsave, chdsave,                      &
...
!   paranoid check
    if(mstar(i) > 48) then
      write(6,'("   stopped in gvec_star_from_cube,  mstar(",i7,") = ")') i,mstar(i)
...
end subroutine gvec_star_from_cube
