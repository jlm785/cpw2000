...
subroutine grsch_mod_c16(also, xvec, hxvec, mtxd, nvec, irow, xscl,      &
                      mxddim)
...
! Modified, name, indentation, xni = 0. March 5 2025. JLM
