...
!            fourier transform to real space
             ...
             call cfft_wf_c16(chd(:,1),id,n1,n2,n3,kd1,kd2,kd3,-1,       &
     &          wrkfft,mxdwrk)
             call cfft_wf_c16(chd(:,2),id,n1,n2,n3,kd1,kd2,kd3,-1,       &
     &          wrkfft,mxdwrk)
             call cfft_wf_c16(chd(:,3),id,n1,n2,n3,kd1,kd2,kd3,-1,       &
     &          wrkfft,mxdwrk)
