...
! output
  ...
  integer, intent(out)               ::  icdiagmax                       !<  maximum number of diagonalization  outer iterations
...
! maximum number of self consistency cycles. Increase to whatever needed
  ...
  if(itmax > 100) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of itmax seems too large: ",i6)') itmax
  endif
  ...
  if(itmax < 5) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of itmax seems too small: ",i6)') itmax
  endif

! maximum number of diagonalization outer cycles. Increase to whatever needed

  icdiagmax = 40
  icdiagmax = esdf_integer('MaxDiagIterations',icdiagmax)
  ...
  if(icdiagmax < 1) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,*) '   Number of diagonalization Ritz iterations set to 1'
  endif

  if(icdiagmax > 100) then
    write(6,*)
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of icdiagmax seems too large: ",i6)') icdiagmax
  endif
  ...
  if(icdiagmax < 5) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of icdiagmax seems too small: ",i6)') icdiagmax
  endif
...
!  epscv = 0.0005
  ...
  if(epscv > 0.001) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of epscv seems too large: ",e12.3)') epscv
  endif
  ...
  if(epscv < 1.0e-7) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of epscv seems too small: ",e12.3)') epscv
  endif
...
!  epspsi = 0.001
  ...
  if(epspsi > 0.01) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of epspsi seems too large: ",e12.3)') epspsi
  endif
  ...
  if(epspsi < 1.0e-8) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of epspsi seems too small: ",e12.3)') epspsi
  endif
...
! conservation of symmetry, and tolerance of symmetry recognition
  ...
  if(symtol > 0.01) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of symtol seems too large: ",e12.3)') symtol
  endif
  ...
  if(symtol < 1.0e-8) then
    ...
    write(6,*) '   WARNING'
    write(6,*)
    write(6,'("    The value of symtol seems too small: ",e12.3)') symtol
  endif
...
! prints the results
  ...
  if(ipr > 2) then
    ...
    write(6,'("   The value of icdiagmax is: ",i6)') icdiagmax
