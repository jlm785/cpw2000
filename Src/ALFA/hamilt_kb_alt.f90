...
!>  Sets up the full hamiltonian matrix for a given k-point
...
subroutine hamilt_kb_alt(rkpt, mtxd, isort, qmod, ekpg,                  &
    hamk,                                                                &
...
! Adapted from hamilt_kb.  14 March 2024. JLM
...
! kinetic energy
  ...
  do i = 1,mtxd
    hamk(i,i) = hamk(i,i) + cmplx(ekpg(i),ZERO,REAL64)
  enddo

! non-local part

  call hamilt_kb_non_local(rkpt, mtxd, isort, hamk,                      &
      ng, kgv,                                                           &
      nqnl, delqnl, vkb, nkb,                                            &
      ntype, natom, rat, adot,                                           &
