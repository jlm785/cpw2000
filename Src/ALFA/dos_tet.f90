...
!>calculates the contribution to the density of states from one tetrahedron
!>implements tetra_QE.pdf

subroutine dos_tet(vol,e,nhist,ehist,dhist,lunif)

! written November 9 1987. jlm
! modified November 17, 2013. jlm
! Modified, documentation, 19 September 2020. JLM
! Modified, sorting, 19 October 2020. JLM
