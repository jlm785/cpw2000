...
!>     from the charge density chd (in electrons per unit cell).
!>     Adapted from the Balbas/Soler xc package

       subroutine xc_cell( author, id1, id2, n1, n2, n3,                 &
     &                     chdr, vxc, adot, exc, rhovxc, strxc )

!      Written 23 February 1999. jlm
!      Modified f90, 15 December 2016.  JLM
!      Modified, documentation, December 2019. JLM
!      copyright INESC-MN/Jose Luis Martins/LCBalbas/Jose Soler
...
!      correct fot the 2*PI
     ...
     &     .or. author == 'wi' .or. author == 'WI') then
